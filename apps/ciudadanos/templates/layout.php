  ...
  <td width="100%">
      ...
      <tr>
        <td width="100%"><table width="100%" height="0%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td rowspan="3" valign="bottom" background="/images/borrar_05.jpg"><span class="Quote Order">Usuario: <?php echo $sf_user->getAttribute('usuario','Sin Autenticar') ?> <br>
          ...
          <td colspan="2" valign="middle" background=" /images/borrar_06.jpg" height="22" align="right">
            ...
            <a href= "javascript: var w = window.open('http://roraima.cidesa.com.ve')">[ Ayuda en L&iacute;nea ]</a>&nbsp;
            <a href="javascript: var w = window.open('http://comunidad.roraima.cidesa.com.ve')">[ Comunidad ]</a>&nbsp;
...
<tr>
      <td valign="top" >
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td align="CENTER"><strong><font size='1'>Copyleft CIDESA 2011. Distribuido bajo la licencia GNU/GPL V2.0</font></strong></td>
          </tr>
          <tr>
